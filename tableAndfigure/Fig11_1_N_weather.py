...
df_Int = pd.read_excel("C:/Users/97899/Desktop/N/Network/Strong_index.xls")
...
for g,color in zip(gbc,category_colors):
...
plt.text(1.5, 0.9, r"$r^2=%.3f$***"%(results.rsquared), fontsize=13)
