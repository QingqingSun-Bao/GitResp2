...
path = "C:/Users/97899/Desktop/N/Single/yang/ya_rem.xls"
df_huang_nested = pd.read_excel(path, sheet_name="ya_loop_rem")
df_huang_nonested = pd.read_excel(path, sheet_name="ya_chain_rem")
...
plt.text(2016, 100, "tau=%.3f***" % tau, fontdict={"size": 13})
plt.xlabel("Time")
plt.ylabel("Number of Ramets/individuals")
