...
for year in range(2008, 2021):
    ...
    for ex in range(1, 39):
        ...
        for jtem in gb_site:
            # 取出现过最优组配的样地jtem
            A=A|set(jtem[1]['物种'])
            print("每个样地的物种数",len(jtem[1]['物种']))
            site_num.append(len(jtem[1]['物种']))
        print("A",A)
        ...
        avg_rich.append(np.mean(site_num))
        # 小尺度1平方米的平均物种丰富度
...
# savedict(site)
write = pd.ExcelWriter("C:/Users/97899/Desktop/N/Richness/rich_all.xls")
