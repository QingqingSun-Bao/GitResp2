...
if __name__ == "__main__":
    ...
    dic_byrank = LoadDict(path + "Attribute/groupbyrank_chain.txt")
    ...
    plt.ylabel("Environment Euclidean", fontdict={"size": 13})
    plt.xlabel("Mean Competition-Coefficient(Superior)", fontdict={"size": 13})
    plt.xticks(x1, labels)
    plt.title("Transitivity",size=13)
    plt.text(2.5, 18, r"$r^2=0.083,p=0.580$")
