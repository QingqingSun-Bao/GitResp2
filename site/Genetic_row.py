...
class GA(object):
    ...
    # 染色体交叉的概率，基因变异的概率
    def __init__(self, Mat, bound, Obser_N, func, DNA_SIZE=None, cross_rate=0.8, mutation=0.1, change=0.05):
        nums = Mat[0].ravel()
    ...
    def log(self):
        return list(zip(self.POP, self.get_fitness()))
...
if __name__ == "__main__":
    ...
    m = Obser_N.shape[0]
    bound = [(0, 1)] * m * m
    ga = GA(C_list, bound, Obser_N, func=func, DNA_SIZE=len(bound))
